db.employee_blank_all.insertMany([
    {
        ...
        'information': {'birthday': new Date('1987-10-10'),' interests': ['плавание', 'шахматы', 'книги']}, 
        'prikaz': {
    ...
    },
    {
        ...
        'information': {'birthday': new Date('1987-07-10'),' interests': ['плавание', 'компьютерные игры']},  
        'prikaz': {
    ...
    },
    {
        ...
        'information': {'birthday': new Date('1967-07-12'),' interests': ['плавание', 'стрельба из лука']},   
        'prikaz': {
			"Номер приказа": 404
		}
    },
    {
        ...
        'information': {'birthday': new Date('1987-01-10'),' interests': ['борьба', 'шашки', 'воллейбол', 'футбол']},  
        'prikaz': {
			"Номер приказа": 15
		}
    },
    ...
    },
    {
        ...
        'information': {'birthday': new Date('1980-01-14'),' interests': ['борьба', 'книги', 'футбол']},  
        'prikaz': {
			"Номер приказа": 1
		}
    },
